...
myGraph.callGraphApi2 = function callGraphApi2() {
    var user = userAgentApplication.getUser();
    if (!user) {
            ...
            .then(function (token) {
                ...
                var body = {
                    ...
                    "invitedUserMessageInfo": {
                        ...
                        "customizedMessageBody": "Hi Josh2, you can find more information here: " + msalconfig.redirectUri //://localhost:30662/"
                    }
                };
                var result = inviteUserAddGroupMember(msalconfig.graphInvitationEndpoint, "POST", body, token, document.getElementById("1"), document.getElementById("1"));
